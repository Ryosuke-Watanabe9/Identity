...
module.exports.invokeFunction = function invokeFunction(user, req) {
	...
	Fabric_Client.newDefaultKeyValueStore({
		...
		console.log(fabric_client.getUserContext(user, true))
		...
		req.targets = peer.org1.peer0.peerObject
		req.txId = tx_id
